...
export default function UploadForm({
  ...
  const isFormValid = image && isResolutionValid && selectedCategoryId && formPlayerName.trim() && submissionsOpen;
  ...
  return (
    <div className="space-y-5 text-white">
      ...
      <div className="p-4 bg-gradient-to-r from-fivem-orange/15 via-amber-500/10 to-transparent border border-fivem-orange/30 rounded-2xl space-y-2">
        ...
        <div className="flex items-center gap-2 pt-1 border-t border-white/10 text-[10px] font-mono text-white/50">
          <AlertCircle size={12} className="text-amber-400 shrink-0" />
          <span>Notice: Limit 1 submission per participant across all categories.</span>
        </div>
      </div>
