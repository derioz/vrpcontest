...
const INITIAL_CHANGELOGS: ChangelogEntry[] = [
  {
    id: 'release-20260818-2035',
    version: 'v1.9.8',
    title: 'Universal Scroll Re-Alignment, Liquid Active Indicator & Cyber-Glass Navigation',
    category: 'UI/UX',
    description: `• Universal Category Scroll Re-Alignment: Fixed scroll coordinator so selecting any category smoothly docks the viewport at the Selected Category Title from any page position (Hero, Rules, halfway between sections, deep submissions, or after scrolling back up).
