...
const INITIAL_CHANGELOGS: ChangelogEntry[] = [
  {
    ...
    category: 'UI/UX',
    description: `• Voter Selection & Historical Audit Resolution: Resolved an issue where voters in the directory were not clickable by normalizing voter identifiers across UIDs, usernames, and composite summary keys. Added dedicated Historical Contest Voter telemetry cards so voters with concluded round activity render their total verified votes seamlessly.
