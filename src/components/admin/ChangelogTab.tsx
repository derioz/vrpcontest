...
const INITIAL_CHANGELOGS: ChangelogEntry[] = [
  {
    ...
    category: 'UI/UX',
    description: `• SeraUI Profile Pop-up Menu Redesign: Overhauled the user profile pop-up menu using SeraUI component patterns (https://seraui.com/docs/dropdown), featuring deep frosted glassmorphism, online status indicators, role badges (System Admin / Verified Member), and seamless spring animations.
