...
const INITIAL_CHANGELOGS: ChangelogEntry[] = [
  {
    ...
    category: 'UI/UX',
    description: `• Magic UI Scroll-Based Velocity Kinetic Hero Typography: Integrated the official Magic UI Scroll-Based Velocity component (https://magicui.design/docs/components/scroll-based-velocity) with Framer Motion kinetic physics, dynamic useVelocity scroll-speed acceleration, inertial spring physics, and seamless multi-row repetition loops.
• Multi-Layer Kinetic Hero Text Architecture: Deployed dual-tier velocity-driven typography across the landing hero stage—featuring ambient backdrop ghost typography and a high-impact glowing gold/orange kinetic ticker strip that dynamically accelerates on page scroll.
